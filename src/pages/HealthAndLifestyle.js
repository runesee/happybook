      ...
      useEffect(()=>{
        async function fetch() {
          ...
          querySnapshot.forEach((doc) => { // doc.data() is never undefined for query doc snapshots
            if (String(doc.data().genre) === 'Helse- og livsstil') {
              counter++;
          ...
          if (counter == 0) {
            ...
            noBooks.innerText = "Det er ingen bøker om helse- og livsstil tilgjengelig";
